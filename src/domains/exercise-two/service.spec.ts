...
describe('ExerciseTwoService unit tests', () => {
    ...
    it('Should transform number in array of digits', () => {
        expect(service.generateArrayOfDigitsFromNumber(49)).toEqual(expect.arrayContaining([4, 9]));
        expect(service.generateArrayOfDigitsFromNumber(103)).toEqual(expect.arrayContaining([1, 0, 3]));
    });
